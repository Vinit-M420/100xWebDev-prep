            ...
            <div className="h-80 rounded-2xl shadow-lg md:col-span-3 hidden md:block bg-white -translate-y-10
                ...
                <div className="md:col-span-5 p-5 text-black col-span-11 bg-none">
                    <div className='flex flex-col gap-2 mb-4 px-2'>
                        ...
                        <h1 className='font-bold text-3xl '>Good Morning, Vinit! 👋</h1>
                    </div>
                ...
                <div className="h-78 rounded-2xl shadow-lg md:col-span-3 bg-white-100 translate-y-25 col-span-11 
                                py-10 px-4 border border-gray-200">
                    <BtnContent />
                </div>
            </div>
        </div>
