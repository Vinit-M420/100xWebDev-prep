...
export const FilterToggle = ( { children }) => {
    ...
    return (
        <div className="inline-flex flex-col gap-3 p-5 rounded-xl bg-neutral-800 font-semibold
                        border border-neutral-600 shadow-md transition-all duration-100 fixed">
            <h2>Status</h2>
            <div className="flex gap-5">
                ...
                <div className="flex gap-2">
                    <input type="checkbox" value="Solved"></input>
                    <label>Solved</label>
                </div>
                <div className="flex gap-2">
                    <input type="checkbox" value="Attempted"></input>
            ...
            <div className="flex gap-3">
                <div className="flex gap-2">
                    <input type="checkbox" value="easy"></input>
                ...
                <div className="flex gap-2">
                    <input type="checkbox" value="hard"></input>
                    <label className="text-red-400">Hard</label>
                </div>
            </div>

            <div className="flex gap-2">
                <input type="checkbox" value="tags"></input>
